...
2. Install Node.js LTS with the normal installation choices.
3. Download this repository as a ZIP and extract it to a permanent folder.
4. Double-click **Set Up NS Local AI.cmd**.
5. Leave the window open while it installs `qwen3-vl:8b-instruct`.
...
Do not commit Ollama models, local runtime logs, environment secrets, temporary document renders, or local agent workspaces.
